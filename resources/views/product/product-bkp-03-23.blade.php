@extends('index')
@section('content')
@php $membership_id=0;$membership_price=0;  Session::put('testProducts', 'yes'); @endphp
<?php $incident_count=$canbook=0;$incidenthapp= $bookingcount= array();?>
                    ...
                    <div class="page-navigation">
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/trident-fleet/{{$data['curBoatDetail']['categoryName']}}">{{$data['curBoatDetail']['categoryName']}}</a></li>
                                <li class="breadcrumb-item active">{{strtoupper($data['curBoatDetail']['boat_name'])}}</li>
                            </ol>
                        </div>
                        <div class="change-product">@if ($data['beforeBoatId']) <a href="/boat-detail/{{$data['beforeBoatId']}}">< Previous Product</a> @else @endif @if ($data['afterBoatId']) <a href="/boat-detail/{{$data['afterBoatId']}}"> Next Product ></a> @else @endif</div>
                    </div>
                </div>
            </div>
        </div>
   ...
   $bookingcount = DB::table('boat_charter_book')->where([
    ['user_id', '=', $user->getAttributes()->user_id], ['status', '=',  '1']])->orderBy('book_id', 'desc')->limit($data['curBoatDetail']['prev_charter'])->get();

 /*echo '<pre>'.  print_r($bookingcount, true).'</pre>';*/
   foreach($bookingcount as $booking_details){
     $book_id = $booking_details->book_id;

    $incidenthapp = DB::table('boat_incident')->where([
    ['user_id', '=', $user->getAttributes()->user_id],['order_id', '=',  $book_id], ['charter_fault', '=',  'Yes']])->get();
    ...
    @endif
       ...
       <div class="container">
        <p class="p-3 alert alert-success">Your request to top-up your credit has been forwarded to the administrator.</p>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <div class="product-left">
                                ...
                                <div class="product-gallery-wrapper">
                                    <div class="product-gallery-slider">
                                        ...
                                        <div class="product-gallery-item">
                                            <div class="content">
                                               <img src="{{asset('images/product/' . $data['curBoatDetail']['photo1'])}}" data-thumb="{{asset('images/product/' . $data['curBoatDetail']['photo1'])}}">
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="product-gallery-item">
                                            <div class="content">
                                               <img src="{{asset('images/product/' . $data['curBoatDetail']['photo2'])}}" data-thumb="{{asset('images/product/' . $data['curBoatDetail']['photo2'])}}">
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="product-gallery-item">
                                            <div class="content">
                                               <img src="{{asset('images/product/' . $data['curBoatDetail']['photo3'])}}" data-thumb="{{asset('images/product/' . $data['curBoatDetail']['photo3'])}}">
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="product-gallery-item">
                                            <div class="content">
                                               <img src="{{asset('images/product/' . $data['curBoatDetail']['photo4'])}}" data-thumb="{{asset('images/product/' . $data['curBoatDetail']['photo4'])}}">
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="product-gallery-item">
                                            <div class="content">
                                               <img src="{{asset('images/product/' . $data['curBoatDetail']['photo5'])}}" data-thumb="{{asset('images/product/' . $data['curBoatDetail']['photo5'])}}">
                                            </div>
                                        </div>
                                        @endif
                                        @if (empty($data['curBoatDetail']['photo1'])
                            ...
                            <div class="description-section">{{strip_tags(\App\Http\Utils\StringDatabase::executeStringToHtml($data['curBoatDetail']['boat_details']))}}</div>
                                    ...
                                    <div class="row">
                                        <div class="rate col-md-4">
                                          ...
                                          {{\App\Http\Utils\StringDatabase::executeNiceNumber($data['curBoatDetail']['boatPrice'])}}  
                                            ...
                                            Additional Pax: {{$data['curBoatDetail']['currency']}} {{$data['curBoatDetail']['price_per_pax']}}</strong></p>
                                            @endif
                                        </div>
                                        <div class="detail col-md-8">
                                            <p class="title">Yacht Details</p>
                                            <div class="row">
                                                <div class="col-lg-6 spec">Boat Type: <span class="highlight">{{$data['curBoatDetail']['categoryName']}}</span></div>
                                                <div class="col-lg-6 spec">Berthed: <span>{{$data['curBoatDetail']['marinas_name']}}</span></div>
                                                <div class="col-lg-6 spec">Length: <span>{{$data['curBoatDetail']['length']}} ft</span></div>
                                                <div class="col-lg-6 spec">Year Build: <span>{{$data['curBoatDetail']['year_create']}}</span></div>
                                                 
                                        <div class="col-lg-6 spec">Beam: <span>{{$data['curBoatDetail']['beam']}} ft</span></div>
                                        <div class="col-lg-6 spec">Self Drive Available: <span>@if ($data['curBoatDetail']['self_drive'] == "1") Yes @else No @endif </span></div>
                                                <div class="col-lg-6 spec">GPS: <span>@if($data['curBoatDetail']['gps']) Yes @else No @endif</span></div>
                                                <div class="col-lg-6 spec">Max. Guests: <span>{{$data['curBoatDetail']['pax']}}</span></div>
                                                <div class="col-lg-6 spec">Fishfinder: <span>@if($data['curBoatDetail']['fishfinder']) Yes @else No @endif</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                           ...
                           <!-- <div class="action-btns"><a class="book-btn" href="#">BOOK NOW</a><a class="back-btn" href="#">BACK TO PREVIOUS</a></div>-->
                            <div class="comments">
                                ...
                                <div class="comment-form">
                                    ...
                                    FILL THE FORM BELOW IF YOU ALREADY BOOKED THIS BOAT.
                                </div>-->
                                            ...
                                            @endif
                                        @else
                                            <button class="button button-highlight">BOOK THIS BOAT TO SUBMIT YOUR REVIEWS.</button>
                                        @endif
                                    @else
                                        <button class="button button-highlight">LOG IN AND BOOK THIS BOAT TO SUBMIT YOUR REVIEWS.</button>
                                    @endif
                                </div>
                            </div>
                            <div class="comments">
                                @if (!empty($data['comments']))
                                    <div class="comments-header">
                                        @if (count($data['comments']) < 2)
                                            {{ count($data['comments']) }} COMMENT
                                        @else
                                        ...
                                        <div class="comment">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    ...
                                                    <span class="comment-time"> on <strong>{{ \Carbon\Carbon::parse($comment->add_date)->format('d, M Y') }}</strong></span>
                                                </div>
                        ...
                        <div class="product-right">
                            <form id="form-process-checkout" action="/payment" method="post">
                                ...
                                @if(\Illuminate\Support\Facades\Auth::check())
                                    ...
                                    $user = \Illuminate\Support\Facades\Auth::user();
                                    ?>
                                    <p>Member Name: <span class="highlight">{{$user->getAttributes()->name}}</span></p>
                                @endif
...
echo '<p class="text-danger charterexp">*This boat requires '.$data['curBoatDetail']['prev_charter'].' most recent charter experience (with zero incident) for booking. </p>';
                                    ...
                                    <p>
                                        @foreach($data['seaSportsFee'] as $item)
                                            <label class="sea-sports-blue font-weight-bold">
                                                ...
                                                <input type="checkbox" name="lists-sea-sports-{{$item['id']}}" value="{{$item['price']}}"> {{$item['name']}}<span class="m-1">S${{$item['price']}}</span>
                                            </label><br>
                                        @endforeach
                                        {{--<label class="sea-sports-blue font-weight-bold">
                                ...
                                <option  value="0">Select Payment</option>
                                    <option value="1">Membership Tier Discount</option>
                                    <option value="2">Credit ID</option>
                                </select> 
                                ...
                                @php $membership_id = $ifmember->membership_id; 
                                ...
                                <p><i class="fa fa-info-circle" aria-hidden="true"></i><small> {!!htmlspecialchars_decode($ifmember->remarks) !!}</small>  </p>
                                @endforeach
                                </div>
                                @else
                                <div class="payment-detail d-none" id="ifmember"><p class="title">Membership Details</p><p class="text-danger">You do not have any membership plan for this boat.</p></div> 
                                @endif
                                ...
                                @php  
                                $balance = DB::table('boat_user_credits_history')->where('credit_id',$credit_info->credit_id)->sum('balance');
                                @endphp

                                <option value="{{$credit_info->credit_id}}|{{ $balance}}"  > {{$credit_info->credit_id}} ( Balance : <?php echo $currencyUnit;?> {{ $balance}}) </option>
                                @php $cin++; @endphp
                                @endforeach 
                                        </select>
                                ...
                                @else
                                <div class="payment-detail d-none" id="myCredits"><p class="title">Credit Details</p><p class="text-danger">The credit amount is insufficient. Kindly top up your credit.</p>
                            <p><a href="{{url('/')}}/sendemail-to-admin" class="btn btn-sm btn-danger">Email Us to Topup</a></div> 
                                ...
                                <div class="payment-detail updatepricerefresh">
                                    ...
                                    <?php
                                    $user = \Illuminate\Support\Facades\Auth::user();
                                    $user_extend= DB::table('boat_user_extend')->where('user_id', $user->getAttributes()->user_id)->first();
                                    ...
                                    <div class="promotion"><span>
                                        <p>Promo Code:</p>
                                        <input type="text">
                                        <p><a href="#">Apply</a><span>|</span><a href="#">Reset</a></p></span><span><?php echo $currencyUnit;?>0.00</span></div>
                                   ...
                                   <div id="paxinfo" class="row d-none">
                                    ...
                                    <div class="col-md-6 pr-0 pl-0"><input type="number" name="maxpax" step="1" class="form-control maxpax" min="5" value="5" ><p class="mt-2"><a href="#" style="font-size: 0.875rem;color: #00cccd;">Apply</a></p></div>
                                    <div class="col-md-3 pl-0"><input type="button" onclick="setpax('inc');" value="+" class="plus   btn btn-sm btn-secondary p-2"></div>
                                    </div>
                                        </div><div class="col-md-5 text-right pt-4"><small><strong><?php echo $currencyUnit;?> 320</strong> Price/Person</small></div>
                                        </div>
                                    <div id="div-paypal-fee" class="d-none">
                                        <span>Paypal Fee ({{$data['paypalFee']}}%):</span>
                                        <span>
                                            <strong class="currency">
                                                <?php echo $currencyUnit;?>
                                            </strong>
                                ...
                                @endphp
                                    <input type="checkbox" id="charteragreement" name="charter-agreement">I have read and accepted fully the terms of charter stated in the charter agreement "<a target="_blank" href="/download/{{$data['curBoatDetail']['contractpaper']}}">Charter Agreement</a>" including indemnities and refund policies.
                                @php
                                else:
                                @endphp
                                <input type="checkbox" id="charteragreement" name="charter-agreement">I have read and accepted the terms & conditions including indemnities and refund policies.
                                @php
                                    endif;    
                                @endphp
                                </label>
...
echo '<button type="button" style="background-color:red;" id="proceed-to-not-checkout">BOAT IS NOT AVAILABLE </button>';
                                    ...
                                    $user = \Illuminate\Support\Facades\Auth::user();
                                    ?>
                                    <input type="hidden" name="login-user-name" value="{{$user->getAttributes()->name}}">
                                ...
                                @else
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#loginModal">LOG IN TO PROCEED</button>
...
if($data['curBoatDetail']['book_type']=="Skippered"){ ?>
 ...
 function checkcreditavailable(cval){
  //  alert(cval);
    ...
    if(book_time_list==""){
        alert("Please Choose Date First");$("select[name=creditinfo]").prop("selectedIndex", 0).val();
